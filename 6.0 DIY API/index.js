...
app.put("/jokes", (req, res) => {
  ...
  let modify = jokes.find((joke) => joke.id === id);

  if (!modify) {
    return res.status(404).json({ error: "Joke not found" });
  }

  modify.jokeText = req.body.text;
  modify.jokeType = req.body.type;
...
app.patch("/jokes", (req, res) => {
  ...
  modify.jokeText = req.body.text || modify.jokeText;
  modify.jokeType = req.body.type || modify.jokeType;
...
app.delete("/all", (req, res) => {
  ...
  } else return res.status(400).json({ error: "The password is incorrect" });
});
